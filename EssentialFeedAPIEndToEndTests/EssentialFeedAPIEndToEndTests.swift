...
//
//  Created by Rishav Gupta on 08/12/21.
//
...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchedFixedAccountData() {
        switch getFeedResult() {
            case let .success(items)?:
                XCTAssertEqual(items.count, 8, "Expected 8 items in the test API feed")
